			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="main-nav">
					<ul class="navlist ul-inline">
						<li class= "nav li-inline <?php echo ($nav == 1) ? 'active' : '' ?>" ><a class="nav-link" href="instructor.php">dashboard</a></li>
						<li class= "nav li-inline <?php echo ($nav == 2) ? 'active' : '' ?>"><a class="nav-link js-nav-sub-link">my courses</a></li>
						<ul class="nav-sub js-nav-sub hide">
							<li class="nav-sub-item"><a href="instructor_course.php">I590 - Data Science Introduction</a></li>
							<li class="nav-sub-item"><a href="instructor_course.php">I593 - Big Data Programming</a></li>
						</ul>
					</ul>
